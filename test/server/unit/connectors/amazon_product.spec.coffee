...
describe 'AmazonProductConnector', ->
    ...
    it 'should return valid data with a response from a valid request', () ->
        ...
        expect(callbackSpy).toHaveBeenCalledWith(null, {
            amazon_link: "http://www.amazon.com/Harry-Potter-Sorcerers-Stone-Book/dp/059035342X%3FSubscriptionId%3DAKIAJAHG2DA422GGAOGA%26tag%3Dbiblio0b-20%26linkCode%3Dxm2%26camp%3D2025%26creative%3D165953%26creativeASIN%3D059035342X",
            auteur: "J.K. Rowling",
            editeur: "Scholastic",
